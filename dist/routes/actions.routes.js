      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            _context2.next = 6;
            return db.collection('actions').insert(action);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            db = _context3.sent;
            _context3.next = 6;
            return db.collection('actions').findOne({
              _id: Object(id)
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            db = _context4.sent;
            _context4.next = 6;
            return db.collection('actions').deleteOne({
          ...
          case 6:
            ...
            res.json({
              message: "Action ".concat(id, " deleted"),
              result: result
            });
